...
2. Части не должны быть слишком длинными (максимум 1000 символов)
3. Части не должны быть слишком короткими (минимум 100 символов)
...
FILE_READ_ERROR_MESSAGE = "Ошибка при чтении файла" 